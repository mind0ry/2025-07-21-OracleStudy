...
public class ClientMainFrame extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==menu.b1) {
			...
			if(id.trim().length()<1) {
				JOptionPane.showMessageDialog(this, "중복체크를 하세요");
				return;
			}
			...
			if(res==0) {
				...
				JOptionPane.showMessageDialog(this, "회원가입에 축하합니다");
		...
		// 우편번호 검색
			...
			if(count==0) {
				JOptionPane.showConfirmDialog(this, "검색결과가 없습니다");
				post.tf.setText("");
				post.tf.requestFocus();
