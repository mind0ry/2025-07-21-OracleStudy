		...
		try {
			...
			for(int i=1;i<=364;i++) {
				...
				for(int j=0;j<link.size();j++) {
					try {
						System.out.println("http://www.menupan.com"+link.get(j).attr("href"));
						String url="http://www.menupan.com"+link.get(j).attr("href");
						...
						vo.setPoster("http://www.menupan.com"+poster.attr("src"));
